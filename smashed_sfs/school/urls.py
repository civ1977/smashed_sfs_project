...
urlpatterns = [
    ...
    path('enrollment/', views.school_enrollment, name='school_enrollment'),
    path('enrollment/queue/<str:grade_level>/', views.school_enrollment_queue, name='school_enrollment_queue'),
    path('enrollment/my-queue/', views.school_enrollment_my_queue, name='school_enrollment_my_queue'),
    path('enrollment/<int:application_id>/', views.school_enrollment_process, name='school_enrollment_process'),
